class TokenomicSection extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
    <section class="tokenomic">
            ...
            <!-- mobile -->
            <img loading="lazy"  src="../assets/images/tokenomic/left-mobile.svg" alt="" class="tokenomic__blur-img left-mobile ">
            <img loading="lazy"  src="../assets/images/tokenomic/right-mobile.svg" alt="" class="tokenomic__blur-img right-mobile ">

            <!-- desktop -->
            <img loading="lazy"  src="../assets/images/tokenomic/left-desktop.svg" alt="" class="tokenomic__blur-img left-desktop">
            <img loading="lazy"  src="../assets/images/tokenomic/right-desktop.svg" alt="" class="tokenomic__blur-img right-desktop">
