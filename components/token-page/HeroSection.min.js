class TokenHeroSection extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
    <section class="hero-full-section">

   <img loading="lazy"  class="hero-full-section__decor hero-full-section__decor--token" src="https://lukasemperfi.github.io/space-lab/assets/images/token-hero/vector.png" alt="hero-section-bg" class="hero-full-section__decor">
      ...
      <div class="hero-full-section__video-container">
        <video 
          ...
          >
            <source src="https://lukasemperfi.github.io/space-lab/assets/video/coin_token.mp4" type="video/mp4">
            <source src="https://lukasemperfi.github.io/space-lab/assets/video/coin.mp4" type="video/mp4"  media="(max-width: 768px)">
...
//# sourceMappingURL=HeroSection.min.js.map
