import{productsData}from"https://lukasemperfi.github.io/space-lab/data/home-page/products.min.js";class ProductSection extends HTMLElement{constructor(){super()}connectedCallback(){this.render()}highlightTitleWords(t,o){let d=t;return o&&o.words&&o.class&&o.words.forEach(t=>{var c=new RegExp(`\\b${t}\\b`,"gi");d=d.replace(c,`<span class="${o.class}">${t}</span>`)}),d}render(){this.innerHTML=`
    ...
    <img loading="lazy"  src="https://lukasemperfi.github.io/space-lab/assets/images/product/decor-right-mobile-1.png" alt="${productsData[0].title}" class="product-card__decor-right-mobile-1">
    <img loading="lazy"  src="https://lukasemperfi.github.io/space-lab/assets/images/product/decor-right-desktop-1.png" alt="${productsData[0].title}" class="product-card__decor-right-desktop-1">
...
<div class="product-card product-card--2">
        <div class="product-card__container">
    <img loading="lazy"  src="https://lukasemperfi.github.io/space-lab/assets/images/product/decor-right-mobile-2.png" alt="${productsData[0].title}" class="product-card__decor-right-mobile-2">
    <img loading="lazy"  src="https://lukasemperfi.github.io/space-lab/assets/images/product/decor-right-desktop-2.png" alt="${productsData[0].title}" class="product-card__decor-right-desktop-2">
        <div class="product-card__col1">
            <video 
                class="product-card__video" 
                autoplay 
      ...
      <div class="product-card product-card--3">
        <div class="product-card__container">
    <img loading="lazy"  src="https://lukasemperfi.github.io/space-lab/assets/images/product/decor-right-mobile-3.png" alt="${productsData[0].title}" class="product-card__decor-right-mobile-3">
    <img loading="lazy"  src="https://lukasemperfi.github.io/space-lab/assets/images/product/decor-right-desktop-3.png" alt="${productsData[0].title}" class="product-card__decor-right-desktop-3">
        <div class="product-card__col1">
            <video 
                class="product-card__video" 
                autoplay 
...
//# sourceMappingURL=ProductSection.min.js.map
