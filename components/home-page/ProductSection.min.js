import{productsData}from"../../data/home-page/products.min.js";class ProductSection extends HTMLElement{constructor(){super()}connectedCallback(){this.render()}highlightTitleWords(t,c){let o=t;return c&&c.words&&c.class&&c.words.forEach(t=>{var d=new RegExp(`\\b${t}\\b`,"gi");o=o.replace(d,`<span class="${c.class}">${t}</span>`)}),o}render(){this.innerHTML=`
